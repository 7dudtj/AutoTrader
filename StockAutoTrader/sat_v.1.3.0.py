"""
    ...
    'sat_v.1.3.0.py' will automatically trade Stocks at Korea Stock Market.
...
if __name__ == '__main__':
    try:
        ...
        buy_percent = 0.3 # (1 / target_buy_count) - commision
        # with consideration of maximum limit price (because of market price policy)
        # ---------------------------------------------------------------
        ...
        while True:
            ...
            if t_start < t_now < t_sell:  
                ...
                if t_now.minute == 30 and 0 <= t_now.second <= 30 and sendMsg == False:
                    get_stock_balance('ALL')
                    sendMsg = True
                if t_now.minute == 31 and 0 <= t_now.second <= 30 and sendMsg == True:
                    sendMsg = False
